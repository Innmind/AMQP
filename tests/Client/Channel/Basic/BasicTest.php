...
class BasicTest extends TestCase
{
    ...
    public function testAck()
    {
        ...
        $this->assertNull(
            $this->basic->ack(Ack::of($deliveryTag)),
        );
    }
    ...
    public function testCancel()
    {
        ...
        $this->assertNull(
            $this->basic->cancel(
                CancelCommand::of('test_cancel_tag'),
            ),
        );
    }
    ...
    public function testCancelWithoutWaiting()
    {
        ...
        $this->assertNull(
            $this->basic->cancel(
                CancelCommand::of('test_cancel_tag')->dontWait(),
            ),
        );
    }
    ...
    public function testConsume()
    {
        ...
        $called = false;
        $this->basic->get(Get::of('test_consume'))(function(
            $message,
            $redelivered,
            $exchange,
            $routingKey,
    ...
    public function testReuseConsumer()
    {
        ...
        $consumer = $this->basic->consume(Consume::of('test_consume'));
        $consumer->take(4);
        $this->assertNull(
    ...
    public function testRejectInConsume()
    {
        ...
        $called = false;
        $this->basic->get(Get::of('test_consume'))(static function() use (&$called): void {
            $called = true;
        });
        $this->assertFalse($called);
    }
    ...
    public function testGetMessageWithAllProperties()
    {
        ...
        $this->assertNull(
            $this->basic->publish(Publish::a($message)->to('amq.direct')),
        );
        $called = false;
    ...
    public function testReuseGet()
    {
        ...
        $get = $this->basic->get(Get::of('test_get'));
        $this->assertNull(
            $get(function(
                Message $message,
                bool $redelivered,
    ...
    public function testRejectGet()
    {
        ...
        $this->assertTrue($called);
        $called = false;
        $this->basic->get(Get::of('test_get'))(static function() use (&$called): void {
            $called = true;
        });
        $this->assertFalse($called);
    }
    ...
    public function testRequeueGet()
    {
        ...
        $this->assertTrue($called);
        $called = false;
        $this->basic->get(Get::of('test_get'))(function($message) use (&$called): void {
            $called = true;
            $this->assertSame('foobar', $message->body()->toString());
        });
        $this->assertTrue($called);
    ...
    public function testReject()
    {
        ...
        $this->assertNull(
            $this->basic->reject(RejectCommand::of($deliveryTag)),
        );
    }
