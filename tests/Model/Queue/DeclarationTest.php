...
class DeclarationTest extends TestCase
{
    ...
    /**
     * @expectedException Innmind\AMQP\Exception\ExclusivePassiveDeclarationNotAllowed
     */
    ...
    /**
     * @expectedException Innmind\AMQP\Exception\PassiveQueueDeclarationMustHaveAName
     */
    ...
    public function testWithArgument()
    {
        ...
        $this->assertSame([42], $command2->arguments()->get('foo'));
    }
}
